    ...
    <div className="flex min-h-[100dvh] flex-col items-center justify-center bg-background px-5 safe-bottom">
      <div className="animate-slide-up text-center">
        ...
        <div className="space-y-3 w-full max-w-xs mx-auto">
          <Button onClick={() => navigate("/tablero")} className="w-full rounded-xl h-11 font-semibold">
            Ir al tablero
          </Button>
          <Button onClick={() => navigate("/seleccionar-operacion")} variant="outline" className="w-full rounded-xl h-11">
            Nueva operación
          </Button>
        </div>
      </div>
